  ...
  return (
    <section className="w-full max-w-3xl mx-auto px-4 sm:px-0 py-12 sm:py-16">
      ...
      <div className="bg-white/[0.05] border border-white/15 rounded-2xl overflow-hidden">
        ...
        {/* Action bar */}
        <div className="border-t border-white/10 bg-white/[0.03] px-4 sm:px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
          <button
            onClick={handleSpin}
            disabled={isSpinning}
          ...
          <button onClick={handleShare} className="text-white/50 hover:text-white text-sm transition-all flex items-center gap-1.5">
        ...
        {/* Streak counter */}
        {sessionCount > 0 && (
          <div className="border-t border-white/10 bg-white/[0.02] px-4 sm:px-6 py-3 text-center">
